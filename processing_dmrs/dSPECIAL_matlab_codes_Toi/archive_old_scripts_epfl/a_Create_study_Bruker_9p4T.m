...
folderexp   = "Y:\DATA\CSI\9.4T-FIDCSI-Data\20250417_084715_Toi_dMRSI_20250417_RatFem_dMRI_SPECIAL_dMRS_1_1_10_cc";
...
BRUKERparamnames=["PVM_SpecAcquisitionTime=","##$PVM_SpecSWH=( 1 )", ...
    ...
    ["##$PVM_ArrayPhase=( 4 )" + sprintf('\n')],["##$PVM_EncChanScaling=( 4 )"+ sprintf('\n')]];
