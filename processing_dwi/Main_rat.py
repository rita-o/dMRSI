...
cfg['algo_denoising']       = 'tMPPCA_5D'       # Options are: 'MPPCA', or 'tMPPCA' or 'tMPPCA_5D'
...
#### ROIS CONFIG ####
cfg['ROIs_GM']       = ['hippocampus','M1','M2','S1','S2', 'V1', 'PL','CG', 'Thal', 'WB'] # List of ROIs to analyse (in GM)
cfg['ROIs_WM']       = ['CC']                   # List of ROIs to analyse (in WM)
