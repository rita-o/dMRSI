...
# -*- coding: utf-8 -*-
"""
Main script to preprocess and analyze diffusion MRI (dMRI) data acquired on HUMANS.

Current parameters are configured for Siemens human dMRI data by default.
