...
cfg['data_path']            = os.path.join(os.path.expanduser('~'), 'Documents','Rita','Data','data_organoids_20250605')
...
cfg['algo_denoising']       = 'MPPCA'                # Options are: 'MPPCA', or 'tMPPCA' or 'tMPPCA_5D'
#cfg['algo_brainextract']    = 'RATS'                # Options are: 'BET' or 'RATS' Not needed for organoids
cfg['anat_thr']             = '1100'                 # 2100, 4000 depending on your data
cfg['anat_format']          = 'T2w'                  # Depends on you anatomical image. Common options are: 'T1w' or 'T2w'
cfg['subject_type']         = 'organoid'             # Options are: 'human' or 'rat'
...
#### ROIS CONFIG ####
cfg['ROIs_GM']       = []    # List of ROIs to analyse (in GM)
...
# 3.3 Register anatomical image to dwi for individual or combined diffusion times. 
