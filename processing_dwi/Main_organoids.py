...
cfg['redo_final_mask']      = 1   # If you want to redo the processing from the creation of the final brain masks set to 1
...
#### ROIS CONFIG ####
cfg['ROIs_GM']       = []    # List of ROIs to analyse (in GM). Defined previously for each atlas in custom_functions. Please read instructions of Step3_registrations
