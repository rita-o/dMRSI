...
shifted_data = data+1000
log_transformed_data = np.log(shifted_data)
sm.qqplot(log_transformed_data, line='45', ax=axes[1,0])
...
axes[0,1].set_title('Jespersen Res')
shifted_data = data+1000
log_transformed_data = np.log(shifted_data)
sm.qqplot(log_transformed_data, line='45', ax=axes[1,1])
